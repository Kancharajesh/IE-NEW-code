...
public class SignUp extends Basetest {
	...
	private void navigateToGetStarted() throws InterruptedException {
		test.log(Status.INFO, "Navigating to Get Started page");
	...
	private void clickOnSignUpButton() throws InterruptedException {
		test.log(Status.INFO, "Clicking on Sign Up button");
	...
	private void enterEmailAndSendCode(String email) throws InterruptedException {
		test.log(Status.INFO, "Entering email and sending code");
		...
		test.log(Status.INFO, "Entered email and clicked on send code");
	...
	private void assertElementText(String xpath, String expectedText, String errorMessage) {
		test.log(Status.INFO, "Asserting element text");
		WebElement element = driver.findElement(By.xpath(xpath));
		String actualText = element.getText();
		Assert.assertEquals(actualText, expectedText, errorMessage);
		test.log(Status.PASS, "Assertion passed for element text: " + expectedText);
	}
	...
	public void clickon_signup() throws InterruptedException {
		...
		assertElementText(prop.getProperty("Signup01"), expectedElementText,
				"Expected and Actual text should be the same");
	...
	public void signup_Invalidemail() throws InterruptedException {
		...
		assertElementText(prop.getProperty("signup-Email-errormessage"), "This Email is invalid. Try again!",
				"Expected and Actual text should be the same");
	...
	public void signup_Invalid_OTP() throws InterruptedException {
		...
		assertElementText(prop.getProperty("signupotperrormessage"), "Please enter a valid code",
				"Expected and Actual text should be the same");
	...
	public void existing_emailid() throws InterruptedException {
		...
		assertElementText(prop.getProperty("existinguser"), "You have a registered account! Just Log in",
				"Expected and Actual text should be the same");
	...
	public void signup_resendcode() throws InterruptedException {
		...
		test.log(Status.PASS, "signup_resendcode test completed successfully");
	}
	...
	public void signup_EmptyEmail() throws InterruptedException {
		...
		assertElementText(prop.getProperty("signup-Email-errormessage"), "Email field cannot be empty",
				"Expected and Actual text should be the same");
	...
	public void signup_MultipleInvalidOtps() throws InterruptedException {
		...
		for (String otp : invalidOtps) {
			...
			test.log(Status.INFO, "Invalid OTP entered: " + otp);
		}
